...
// Interface to match the prop passed in App.tsx
...
export default function Treatment({ onBack }: TreatmentProps) {
  ...
  return (
    <div style={{ backgroundColor: theme.bg }} className="min-h-screen flex flex-col font-sans selection:bg-[#1A3C34] selection:text-[#F2F0EA]">
      <Header />
            ...
            {!selectedCategory ? (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* Safe Access to Subcategories using "keyof" */}
                  {selectedCategory && subcategories[selectedCategory as keyof typeof subcategories] && subcategories[selectedCategory as keyof typeof subcategories].map((sub, i) => (
                    <div
                      key={i}
